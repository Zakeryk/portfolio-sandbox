...
export class GameEngine {
  ...
  createTooltip() {
    ...
    const title = new PIXI.Text('', { fontSize: 12, fill: 0xffffff, fontWeight: 'bold', align: 'center', resolution: window.devicePixelRatio * 2 })
    title.anchor.set(0.5, 0)

    const content = new PIXI.Text('', { fontSize: 11, fill: 0xcccccc, lineHeight: 15, align: 'center', resolution: window.devicePixelRatio * 2 })
